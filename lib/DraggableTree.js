...
var DraggableTree = function () {
            ...
            this.selectingIdSet.forEach(function (id) {
                promises.push(new Promise(function (resolve, reject) {
                    try {
                        ...
                        var node = _this.map.get(id),
                            nodeDom = _this.__getNodeDomById(id);
                        ...
                        if (node) {
                            if (node.parentId === _this.topParent) {
                                deleteByValueFromArray(node.id, _this.rootList);
                            } else {
                                var parentNode = _this.map.get(node.parentId);
                    ...
                    _this.selectingIdSet.delete(id);
                }));
            });
    ...
    Tree.prototype.clearSelected = function () {
        ...
        this.selectingIdSet.forEach(function (id) {
            var layerDom = _this2.__getNodeDomById(id);

            if (layerDom) {
                layerDom.classList.remove("selected");
            }

            _this2.selectingIdSet.clear();
        });
    };
